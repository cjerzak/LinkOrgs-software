...
#BuildBackend(conda_env = "LinkOrgsEnv",  # or choose a custom name
             #conda = "auto",
             #tryMetal = TRUE)
```
...
That’s it! You’ve seen how to install the LinkOrgs package, build a conda environment for advanced ML matching, run the main function with various algorithms, and evaluate your matches.
...
For more information, see the function reference in our GitHub repo. Feel free to file an issue or pull request there if you encounter difficulties.

Enjoy streamlined organization record linking with LinkOrgs!
